...
const songs = [
  ...
  { ele: Themachine, audioName: "The Machine", artist: "Reed Wonder & Aurora Olivas", img: "src/img/music/themachine.jpg" },
...
// ✅ Preload all song images (fixes lag on switching songs)
songs.forEach(song => {
  const img = new Image();
  img.src = song.img;
});
...
// Smooth fade transition setup (optional but looks cool)
...
const updateSong = (action) => {
  ...
  // Optional fade effect when image changes
